...
const genderLabels = [{ id: 'female', label: 'Female' }, { id: 'male', label: 'Male' }];
...
export default function FilterBar(
  ...
  return (
    <div className="fixed w-screen" style={barStyles}>
      <div ref={contentEl} className="h-[--bar-height] z-10 flex bg-dark-950 py-2.5 px-3 gap-3 border-b-[1px] border-b-dark-700 overflow-x-scroll hide-scrollbar">
        <Dropdown defaultLabel='price' children={
          <div className={`${styles['dropdown-price']} shadow-lg shadow-dark-700 flex gap-1 items-center w-[320px] p-2 bg-dark-950`}>
            <fieldset className="m-0 flex-1">
              <label htmlFor="min-input" className="screenReaderOnly">minimum Rent Input</label>
              <input
            ...
            <fieldset className="m-0 flex-1">
              <label htmlFor="max-input" className="screenReaderOnly">maximum Rent Input</label>
              <input
                className="bg-dark-700 text-dark-200 placeholder:text-dark-400 outline-none border-2 border-dark-700 focus:border-dark-600 shadow shadow-dark-600 w-full p-2 h-[40px] rounded-lg"
                id="max-input"
                maxLength={6}
        ...
        <Dropdown defaultLabel='type' children={
        ...
        <Dropdown defaultLabel='move-in date' children={
        ...
        <Dropdown defaultLabel='move-out date' children={
          <div className="dropdown-date shadow-[0_0_3px_0_white] shadow-dark-700">
            <Calendar
        ...
        <Dropdown defaultLabel='gender' children={
          <div className="gap-2 shadow-[0_0_3px_0_white] shadow-dark-700 flex flex-col w-[222px] bg-dark-950 p-2">
            <TypeDropdownPane
              types={genderLabels}
